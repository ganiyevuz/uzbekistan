...
class TestUzbekistanConfig(TestCase):
    ...
    def test_app_config_attributes(self):
        ...
        self.assertEqual(self.app_config.default_auto_field, 'django.db.models.BigAutoField')

    @override_settings(UZBEKISTAN={'models': {'region': False, 'district': True, 'village': True}, 'views': {'region': True}})
    ...
    @override_settings(UZBEKISTAN={'models': {'region': True, 'district': False, 'village': True}, 'views': {'region': True}})
